...
with col1:
    ...
    st.link_button("Roberto's Cybersecurity Tool -> Google Hacking -> Hacking search engines",type="secondary", "https://github.com/web-roberto/cybersecurity_python/blob/main/1_1_1_hacking_buscadores_parte1/ninjadorks.py")
