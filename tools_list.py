...
with col1:
    ...
    st.link_button("Roberto's Cybersecurity Tool -> Google Hacking -> Hacking search engines","https://github.com/web-roberto/cybersecurity_python/blob/main/1_1_1_hacking_buscadores_parte1/ninjadorks.py",help=None, type="secondary", icon=None, disabled=False, use_container_width=None, width="content", shortcut=None)
