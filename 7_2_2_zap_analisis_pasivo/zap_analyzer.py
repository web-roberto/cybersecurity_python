...
class ZapSpider:
    ...
    def display_results(self):
        ...
        operation = st.radio("Elige la operación:", ('Spidering', 'Passive Scan'))
    ...
    def _display_alerts(self, alerts: list):
        """
        Muestra las alertas generadas por el escaneo pasivo.

        Args:
            alerts (list): Lista de alertas generadas por el escaneo pasivo.
        """
